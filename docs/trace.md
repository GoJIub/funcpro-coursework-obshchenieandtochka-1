...
Режим трассировки показывает пошаговое вычисление программы: входы в `eval`,
вызовы функций/builtins, `force thunk`, успешные результаты и ошибки — с
отступами по глубине вложенности.
...
| `force thunk` | без отдельного цвета | вычисление отложенного выражения |
